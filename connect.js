...
auth: state,
browser: ["Made By Fizzx`", "IOS", "4.1.0"],
}
...
Biiofc.autosw = true;
  Biiofc.public = true;
  Biiofc.sendsw = `212768821701@s.whatsapp.net`;
...
Biiofc.ev.on('connection.update', async (update) => {
      ...
      if (connection === 'connecting') {
       ...
       console.log("[ Botz ] running")
     } else if (connection === 'open') {
         console.log(chalk.green(`Terhubung Ke WhatsApp Menggunakan FizzxHost Official..`))
  //       Biiofc.sendMessage("6285877276864@s.whatsapp.net", {text:`${JSON.stringify(update, undefined, 2)}`})}


         Biiofc.sendMessage(Biiofc.sendsw, {
                text: `*Terhubung Menggunakan Script Premium FizzxHost🏅*`,
              });
